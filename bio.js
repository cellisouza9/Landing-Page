...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const respostas = {
        ...
        humano: {
            ...
            cta: { texto: 'Chamar no WhatsApp', href: 'https://wa.me/5500000000000' },
    ...
    function addMsg(html, isUser) {
        ...
        const avatar = isUser
            ...
            : '<img src="Elementos PNG/robozinho.png" alt="Robô Celly">';
        div.innerHTML =
    ...
    function mostrarDigitando() {
        ...
        div.innerHTML =
            '<div class="bio-ia-msg-avatar"><img src="Elementos PNG/robozinho.png" alt="Robô Celly"></div>' +
